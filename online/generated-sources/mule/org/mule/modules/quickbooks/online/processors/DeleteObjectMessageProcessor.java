...
/**
 * DeleteObjectMessageProcessor invokes the {@link org.mule.modules.quickbooks.online.QuickBooksOnlineModule#deleteObject(java.lang.String, com.intuit.ipp.core.IEntity)} method in {@link QuickBooksOnlineModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, DeleteObjectMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            final IEntity _transformedObject = ((IEntity) evaluateAndTransform(getMuleContext(), event, DeleteObjectMessageProcessor.class.getDeclaredField("_objectType").getGenericType(), null, object));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((QuickBooksOnlineModule) object).deleteObject(_transformedAccessTokenId, _transformedObject);
                    return null;
                }
