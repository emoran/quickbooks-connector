...
/**
 * PaginatedQueryMessageProcessor invokes the {@link org.mule.modules.quickbooks.online.QuickBooksOnlineModule#paginatedQuery(java.lang.String, java.lang.String, java.lang.Integer)} method in {@link QuickBooksOnlineModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    protected Object resultsPerPage;
    protected Integer _resultsPerPageType;
     ...
     */
    public void setResultsPerPage(Object value) {
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, PaginatedQueryMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            ...
            final Integer _transformedResultsPerPage = ((Integer) evaluateAndTransform(getMuleContext(), event, PaginatedQueryMessageProcessor.class.getDeclaredField("_resultsPerPageType").getGenericType(), null, resultsPerPage));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((QuickBooksOnlineModule) object).paginatedQuery(_transformedAccessTokenId, _transformedQuery, _transformedResultsPerPage);
                }
