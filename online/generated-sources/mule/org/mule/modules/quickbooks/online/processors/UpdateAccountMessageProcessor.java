...
/**
 * UpdateAccountMessageProcessor invokes the {@link org.mule.modules.quickbooks.online.QuickBooksOnlineModule#updateAccount(java.lang.String, com.intuit.ipp.data.Account)} method in {@link QuickBooksOnlineModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.3", date = "2014-08-22T10:01:32-05:00", comments = "Build 3.4.3.1620.30ea288")
public class UpdateAccountMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, UpdateAccountMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            final Account _transformedAccount = ((Account) evaluateAndTransform(getMuleContext(), event, UpdateAccountMessageProcessor.class.getDeclaredField("_accountType").getGenericType(), null, account));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((QuickBooksOnlineModule) object).updateAccount(_transformedAccessTokenId, _transformedAccount);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("updateAccount"), event, e);
        }
    }
