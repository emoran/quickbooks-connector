...
/**
 * CreateVendorMessageProcessor invokes the {@link org.mule.modules.quickbooks.online.QuickBooksOnlineModule#createVendor(java.lang.String, com.intuit.ipp.data.Vendor)} method in {@link QuickBooksOnlineModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.3", date = "2014-08-25T05:23:44-05:00", comments = "Build 3.4.3.1620.30ea288")
public class CreateVendorMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, CreateVendorMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            final Vendor _transformedVendor = ((Vendor) evaluateAndTransform(getMuleContext(), event, CreateVendorMessageProcessor.class.getDeclaredField("_vendorType").getGenericType(), null, vendor));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((QuickBooksOnlineModule) object).createVendor(_transformedAccessTokenId, _transformedVendor);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("createVendor"), event, e);
        }
    }
