...
/**
 * CreateJournalEntryMessageProcessor invokes the {@link org.mule.modules.quickbooks.online.QuickBooksOnlineModule#createJournalEntry(java.lang.String, com.intuit.ipp.data.JournalEntry)} method in {@link QuickBooksOnlineModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.3", date = "2014-08-15T04:14:53-05:00", comments = "Build 3.4.3.1620.30ea288")
public class CreateJournalEntryMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, CreateJournalEntryMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            final JournalEntry _transformedJournalEntry = ((JournalEntry) evaluateAndTransform(getMuleContext(), event, CreateJournalEntryMessageProcessor.class.getDeclaredField("_journalEntryType").getGenericType(), null, journalEntry));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((QuickBooksOnlineModule) object).createJournalEntry(_transformedAccessTokenId, _transformedJournalEntry);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("createJournalEntry"), event, e);
        }
    }
