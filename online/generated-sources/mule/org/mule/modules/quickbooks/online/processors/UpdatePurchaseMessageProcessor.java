...
/**
 * UpdatePurchaseMessageProcessor invokes the {@link org.mule.modules.quickbooks.online.QuickBooksOnlineModule#updatePurchase(java.lang.String, com.intuit.ipp.data.Purchase)} method in {@link QuickBooksOnlineModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.3", date = "2014-08-21T02:54:07-05:00", comments = "Build 3.4.3.1620.30ea288")
public class UpdatePurchaseMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, UpdatePurchaseMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            final Purchase _transformedPurchase = ((Purchase) evaluateAndTransform(getMuleContext(), event, UpdatePurchaseMessageProcessor.class.getDeclaredField("_purchaseType").getGenericType(), null, purchase));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((QuickBooksOnlineModule) object).updatePurchase(_transformedAccessTokenId, _transformedPurchase);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("updatePurchase"), event, e);
        }
    }
