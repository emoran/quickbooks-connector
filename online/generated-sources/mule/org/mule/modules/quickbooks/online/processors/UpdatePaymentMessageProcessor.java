...
/**
 * UpdatePaymentMessageProcessor invokes the {@link org.mule.modules.quickbooks.online.QuickBooksOnlineModule#updatePayment(java.lang.String, com.intuit.ipp.data.Payment)} method in {@link QuickBooksOnlineModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.3", date = "2014-08-25T05:23:44-05:00", comments = "Build 3.4.3.1620.30ea288")
public class UpdatePaymentMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, UpdatePaymentMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            final Payment _transformedPayment = ((Payment) evaluateAndTransform(getMuleContext(), event, UpdatePaymentMessageProcessor.class.getDeclaredField("_paymentType").getGenericType(), null, payment));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((QuickBooksOnlineModule) object).updatePayment(_transformedAccessTokenId, _transformedPayment);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("updatePayment"), event, e);
        }
    }
