...
/**
 * UpdateTermMessageProcessor invokes the {@link org.mule.modules.quickbooks.online.QuickBooksOnlineModule#updateTerm(java.lang.String, com.intuit.ipp.data.Term)} method in {@link QuickBooksOnlineModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.3", date = "2014-08-22T02:35:33-05:00", comments = "Build 3.4.3.1620.30ea288")
public class UpdateTermMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, UpdateTermMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            final Term _transformedTerm = ((Term) evaluateAndTransform(getMuleContext(), event, UpdateTermMessageProcessor.class.getDeclaredField("_termType").getGenericType(), null, term));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((QuickBooksOnlineModule) object).updateTerm(_transformedAccessTokenId, _transformedTerm);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("updateTerm"), event, e);
        }
    }
