...
public class SalesReceiptExpressionHolderTransformer
    ...
    implements DiscoverableTransformer, MessageTransformer
{
    ...
    public boolean isSourceTypeSupported(Class<?> aClass) {
        return (aClass == SalesReceiptExpressionHolder.class);
    }
    ...
    public List<Class<?>> getSourceTypes() {
        return Arrays.asList(new Class<?> [] {SalesReceiptExpressionHolder.class });
    }

    public List<DataType<?>> getSourceDataTypes() {
        return Arrays.asList(new DataType<?> [] {DataTypeFactory.create(SalesReceiptExpressionHolder.class)});
    }
        ...
        throws TransformerMessagingException
    {
        ...
        SalesReceiptExpressionHolder holder = ((SalesReceiptExpressionHolder) src);
        SalesReceipt result = new SalesReceipt();
        try {
            final IntuitAnyType _transformedSalesReceiptEx = ((IntuitAnyType) evaluateAndTransform(this.muleContext, event, SalesReceiptExpressionHolder.class.getDeclaredField("_salesReceiptExType").getGenericType(), null, holder.getSalesReceiptEx()));
            result.setSalesReceiptEx(_transformedSalesReceiptEx);
