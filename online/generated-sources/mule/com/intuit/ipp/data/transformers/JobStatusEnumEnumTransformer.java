...
public class JobStatusEnumEnumTransformer
    ...
    implements DiscoverableTransformer
{
    ...
    public JobStatusEnumEnumTransformer() {
        registerSourceType(DataTypeFactory.create(String.class));
        setReturnClass(JobStatusEnum.class);
        setName("JobStatusEnumEnumTransformer");
    }
        ...
        throws TransformerException
    {
        ...
        result = Enum.valueOf(JobStatusEnum.class, ((String) src));
        return result;
    }
