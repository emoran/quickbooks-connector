...
/**
 * Provides the definition that allows bulk data transfer of Ship Methods
 * 
 * <p>Java class for ShipMethods complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ShipMethods">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.intuit.com/sb/cdm/v2}CdmCollections">
 *       &lt;sequence>
 *         &lt;element name="ShipMethod" type="{http://www.intuit.com/sb/cdm/v2}ShipMethod" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ShipMethods", propOrder = {
    "shipMethod"
})
    ...
    implements Serializable
{
    ...
    public List<ShipMethod> getShipMethod() {
        if (shipMethod == null) {
            shipMethod = new ArrayList<ShipMethod>();
        }
     ...
     *     
     */
    public void setShipMethod(List<ShipMethod> shipMethod) {
