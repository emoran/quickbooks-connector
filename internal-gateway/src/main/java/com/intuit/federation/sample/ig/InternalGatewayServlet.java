...
//            }
			...
			char[] privateKeyPassword, String privateKeyAlias, String keystorePath) throws Exception 
	{
		...
		ks.load(new ClasspathResource("/" + keystorePath).getInputStream(), keyStorePassword);
	...
	private void verifyXmlSignature(String uncryptedXML) throws Exception 
	{
		...
		Certificate intuitCert = cf.generateCertificate(new ClasspathResource("/" + prdCrtFile).getInputStream());
