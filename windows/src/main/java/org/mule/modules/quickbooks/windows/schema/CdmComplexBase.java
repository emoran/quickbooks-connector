...
@XmlSeeAlso({
    ...
    Report.class,
    CDCObjectResponses.class,
    SyncStatusResponses.class,
    SyncActivityResponses.class,
    BatchResponseSet.class,
    AbstractResponse.class,
    CdmCollections.class
})
public abstract class CdmComplexBase implements Serializable
{
