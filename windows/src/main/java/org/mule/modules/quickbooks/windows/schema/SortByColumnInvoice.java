...
/**
 * <p>Java class for SortByColumnInvoice.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="SortByColumnInvoice">
...
public enum SortByColumnInvoice {
    ...
    public static SortByColumnInvoice fromValue(String v) {
        for (SortByColumnInvoice c: SortByColumnInvoice.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
