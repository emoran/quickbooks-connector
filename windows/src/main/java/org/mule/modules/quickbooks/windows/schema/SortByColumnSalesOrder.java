...
/**
 * <p>Java class for SortByColumnSalesOrder.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="SortByColumnSalesOrder">
...
public enum SortByColumnSalesOrder {
    ...
    SortByColumnSalesOrder(String v) {
        value = v;
    }
    ...
    public static SortByColumnSalesOrder fromValue(String v) {
        for (SortByColumnSalesOrder c: SortByColumnSalesOrder.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
