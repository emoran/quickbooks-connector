...
/**
 * <p>Java class for SortByColumnBill.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="SortByColumnBill">
...
public enum SortByColumnBill {
    ...
    public static SortByColumnBill fromValue(String v) {
        for (SortByColumnBill c: SortByColumnBill.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
