...
/**
 * <p>Java class for SortByColumnBillPayment.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="SortByColumnBillPayment">
...
public enum SortByColumnBillPayment {
    ...
    SortByColumnBillPayment(String v) {
        value = v;
    }
    ...
    public static SortByColumnBillPayment fromValue(String v) {
        for (SortByColumnBillPayment c: SortByColumnBillPayment.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
