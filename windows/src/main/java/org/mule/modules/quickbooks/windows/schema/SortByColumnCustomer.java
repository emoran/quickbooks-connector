...
/**
 * <p>Java class for SortByColumnCustomer.
 * 
...
public enum SortByColumnCustomer {
     ...
     * 
     *             Product: QBW
     *             Description: Note: Deprecated. The sorting for this entity is performed by using the "Name" element, not the "LastName".
     *           
     * 
     */
    ...
    public static SortByColumnCustomer fromValue(String v) {
        for (SortByColumnCustomer c: SortByColumnCustomer.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
