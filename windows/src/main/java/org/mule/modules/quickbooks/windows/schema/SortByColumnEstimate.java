...
/**
 * <p>Java class for SortByColumnEstimate.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="SortByColumnEstimate">
...
public enum SortByColumnEstimate {
    ...
    public static SortByColumnEstimate fromValue(String v) {
        for (SortByColumnEstimate c: SortByColumnEstimate.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
