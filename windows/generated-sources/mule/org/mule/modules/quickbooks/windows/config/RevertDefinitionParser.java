...
import org.mule.modules.quickbooks.windows.processors.RevertMessageProcessor;
...
public class RevertDefinitionParser
    extends AbstractDefinitionParser
{


    public BeanDefinition parse(Element element, ParserContext parserContext) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(RevertMessageProcessor.class.getName());
