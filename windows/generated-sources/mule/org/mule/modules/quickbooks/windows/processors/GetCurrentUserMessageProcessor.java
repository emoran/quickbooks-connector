...
/**
 * GetCurrentUserMessageProcessor invokes the {@link org.mule.modules.quickbooks.windows.QuickBooksWindowsModule#getCurrentUser(java.lang.String)} method in {@link QuickBooksWindowsModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.3", date = "2014-08-21T02:51:05-05:00", comments = "Build 3.4.3.1620.30ea288")
public class GetCurrentUserMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, GetCurrentUserMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((QuickBooksWindowsModule) object).getCurrentUser(_transformedAccessTokenId);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("getCurrentUser"), event, e);
        }
    }
