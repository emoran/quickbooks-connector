    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedAccessTokenId = ((String) evaluateAndTransform(getMuleContext(), event, RevertMessageProcessor.class.getDeclaredField("_accessTokenIdType").getGenericType(), null, accessTokenId));
            final WindowsEntityType _transformedType = ((WindowsEntityType) evaluateAndTransform(getMuleContext(), event, RevertMessageProcessor.class.getDeclaredField("_typeType").getGenericType(), null, type));
            final Object _transformedEntityObject = ((Object) evaluateAndTransform(getMuleContext(), event, RevertMessageProcessor.class.getDeclaredField("_entityObjectType").getGenericType(), null, entityObject));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((QuickBooksWindowsModule) object).revert(_transformedAccessTokenId, _transformedType, _transformedEntityObject);
                    return null;
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("revert"), event, e);
        }
    }
